            ...
            <div class="row pt-3">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{isset($frequency)? Route('app.frequency.update',[$frequency->id]): Route('app.frequency.store')}}" method="POST">
                                @if(isset($frequency))
                                    @method('PUT')
                                @endif
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Enter Name" value="{{ $frequency->name ?? old('name') }}">
                                    @error('name')
