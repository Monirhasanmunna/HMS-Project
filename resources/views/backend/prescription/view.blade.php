...
<div class="content-wrapper">
  ...
  <div class="page d-flex flex-column justify-content-between" style="min-height: 100vh;">
    ...
    <div>
      ...
      <div class="d-flex">
        <div class="col-4 ps-5 border border-top-0 border-bottom-0 border-start-0 border-right-1">
          <div class="mt-2">
            <p class="border mb-0 border-gray border-end-0 border-start-0 border-top-0">
              <b>Patient Details</b>
            </p>
            <div>
