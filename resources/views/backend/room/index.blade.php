                ...
                <div class="col-12">
                  <div class="card">
                    <div class="card-header">
                      <h3 class="card-title text-primary"><i class="fa-solid fa-user-doctor"></i><span class="pl-1">Rooms</span></h3>
                      <div class="text-right">
                        <a href="{{Route('app.room.create')}}" class="btn btn-sm btn-primary pull-right">Add New</a>
                      </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
        ...
        function roomDelete(id){
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                    url      : '/app/setting/room/delete/'+id,
                    dataType : 'json',
                    Type     : 'Delete',
