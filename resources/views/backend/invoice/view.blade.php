              ...
              <div class="page pb-0 d-flex flex-column justify-content-between">
                <div>
                  ...
                  <div class="row px-4 mt-2">
                    <div class="col-6">
                      <p class="mb-0"><b>{{isset($prescription) ? $prescription->patient->name : $admission->patients->name}}</b></p>
                    </div>
                    <div class="col-6">
                  ...
                  <div class="row px-4 justify-content-between mb-3">
                    ...
                    <div class="col-7 text-right">
                      <small>
                        <p class="m-0 p-0 text-gray">
                          Supervise BT: <b>{{isset($prescription) ? $prescription->doctor->name : $admission->patients->doctor->name}}({{isset($prescription) ? $prescription->doctor->degrees : $admission->patients->doctor->degrees}})</b>
                        </p>
