            ...
            <div class="row pt-3">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{isset($followup)? Route('app.followup.update',[$followup->id]): Route('app.followup.store')}}" method="POST">
                                @if(isset($followup))
                                    @method('PUT')
                                @endif
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Follow Up Time" value="{{ $followup->name ?? old('name') }}">
                                    @error('name')
