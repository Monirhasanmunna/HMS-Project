            ...
            <div class="row pt-3">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{isset($quantity)? Route('app.quantity.update',[$quantity->id]): Route('app.quantity.store')}}" method="POST">
                                @if(isset($quantity))
                                    @method('PUT')
                                @endif
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Enter Name" value="{{ $quantity->name ?? old('name') }}">
                                    @error('name')
